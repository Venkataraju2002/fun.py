...
def valid(s1,s2,s3,s4,s5,s6):
    if ((s1>=0 and s2>=0 and s3>=0 and s4>=0 and s5>=0 and s6>=0) and (s1<=100 and s2<=100 and s3<=100 and s4<=100 and s5<=100 and s6<=100)):
        return 1
    else:
        return 0
s1,s2,s3,s4,s5,s6=map(int,input().split())    
if valid(s1,s2,s3,s4,s5,s6):
    print("validmarks",s1,s2,s3,s4,s5,s6)
    ...
    per=find_per(total)
    print(total,per)
    b1=bl_count(s1,s2,s3,s4,s5,s6)
    print(b1,total,per,end=" ")
    if b1==0:
